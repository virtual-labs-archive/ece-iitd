...
public class network extends Applet implements ActionListener , Runnable{
	...
	public void PaintInitialGrid(Graphics g){
		...
		if(server.getState()){
			if(serverNum.getSelectedIndex() == 0){
				...
				g.drawString("Mean Sojourn Time in System 1", 60, 490);
				...
				g.drawString("Utilisation of server 1 ", 60, 520);
			...
			if(parameterReqd.getSelectedIndex() == 0){
				...
				g.drawString("" + truncate(MeanNoCustomersQue1 + MeanNoCustomersQue2+MeanNoCustomersQue3+MeanNoCustomersQue4), 450, 400);
				...
				g.drawString("" + truncate(qaz + qax + qac+ qav ) , 450, 400 );
				g.drawString("Mean Sojourn Time with node 1", 60, 430);
				g.drawString("" + truncate(qaz ) , 450, 430 );
				g.drawString("Mean Sojourn Time with node 2", 60, 460);
				g.drawString("" + truncate(qax) , 450, 460 );
				g.drawString("Mean Sojourn Time with node 3", 60, 490);
				g.drawString("" + truncate(qac ) , 450, 490 );
				g.drawString("Mean Sojourn Time with node 4", 60, 520);
				g.drawString("" + truncate(qav ) , 450, 520 );
			}else{
   ...
   public void HandleError(int e) {
    ...
    public void init() {
		...
		queueGraphTotal  = new Checkbox("Total System" , null  , true);
		queueGraph1  = new Checkbox("Node 1        " , null  , false);
        ...
        c.gridx = 0;
		c.gridy = 11;
		p1.add(new Label("Output Measures"), c);
		c.gridx = 0;
        c.gridy = 2;
        p1.add(label1, c);
        c.gridx=1;
