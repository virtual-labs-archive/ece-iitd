...
public class Layout extends Applet implements ActionListener, ItemListener, Runnable {
    ...
    public int GetNumberofArrivals() {
        if (bulkArrival.getState()) {
            if (bulkArrDist.equals("Constant")) {
                return (int) (bulkArrPara1);
            }
            if (bulkArrDist.equals("Uniform")) {
                return (int) Distributions.uniform((int) (bulkArrPara1), (int) (bulkArrPara2));
            }
            if (bulkArrDist.equals("Binomial")) {
                return Distributions.Binomial((int) (bulkArrPara1), bulkArrPara2);
            }
            if (bulkArrDist.equals("Geometric")) {
                return Distributions.geometric(bulkArrPara1);
            }
            if (bulkArrDist.equals("Poisson")) {
                return Distributions.poisson(bulkArrPara1);
            }
        }
        return 1;
    }
    ...
    Label label1, label2, label3, label4, label5, label6, label7, label8, label9, label10, label11, label12, label13,label15;
    Choice bulkArrivalDist;
    Button startButton;
    Button resetButton;
    Choice ArrivalDist;
    ...
    public void init() {
        ...
        label1 = new Label();
        label1.setText("Arrival Distribution :");
        ...
        bulkArrivalDist = new Choice();
        bulkArrivalDist.addItem("Constant");
        bulkArrivalDist.addItem("Uniform");
        bulkArrivalDist.addItem("Binomial");
        bulkArrivalDist.addItem("Geometric");
        bulkArrivalDist.addItem("Poisson");
        bulkArrivalDist.addItemListener(this);
        bulkArrivalDist.enable(false);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == startButton) {
            if (startButton.getLabel().equals("Start")) {
                if (started == false) {
                    ...
                    if (bulkArrival.getState()) {
                        bulkArrDist = bulkArrivalDist.getSelectedItem();
                        try {
                            bulkArrPara1 = Double.parseDouble(arrBulkPara1.getText());
                        } catch (NumberFormatException ee) {
                            etype = 81;
                            HandleError(etype);
                            bulkArrPara1 = 1;
                        ...
                        if (arrBulkPara2.isEnabled()) {
                            try {
                                bulkArrPara2 = Double.parseDouble(arrBulkPara2.getText());
                            } catch (NumberFormatException ee) {
                                etype = 91;
                                HandleError(91);
                                bulkArrPara2 = 1;
        ...
        if (e.getSource() == resetButton) {
            ...
            if (bulkArrival.getState()) {
                ...
                if (bulkArrivalDist.getSelectedItem().equals("Binomial") || bulkArrivalDist.getSelectedItem().equals("Uniform")) {
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (e.getSource() == bulkArrival) {
            if (bulkArrival.getState()) {
                ...
                label2.enable(true);
                bulkArrivalDist.enable(true);
                if (bulkArrivalDist.getSelectedItem() == "Constant") {
                    arrBulkPara1.enable(true);
                    arrBulkPara2.enable(false);
                    label3.enable(false);
                }
                if (bulkArrivalDist.getSelectedItem() == "Uniform") {
                    arrBulkPara1.enable(true);
                    arrBulkPara2.enable(true);
                    label3.enable(true);
                }
                if (bulkArrivalDist.getSelectedItem() == "Binomial") {
                    arrBulkPara1.enable(true);
                    arrBulkPara2.enable(true);
                    label3.enable(true);
                }
                if (bulkArrivalDist.getSelectedItem() == "Geometric") {
                    arrBulkPara1.enable(true);
                    arrBulkPara2.enable(false);
                    label3.enable(false);
                }
                if (bulkArrivalDist.getSelectedItem() == "Poisson") {
                    arrBulkPara1.enable(true);
                    arrBulkPara2.enable(false);
                    label3.enable(false);
                }
        ...
        if (e.getSource() == bulkArrivalDist) {
            if (bulkArrivalDist.getSelectedItem() == "Constant") {
                arrBulkPara1.enable(true);
                arrBulkPara2.enable(false);
                label3.enable(false);
    ...
    public void run() {
        ...
        g.drawString("N/A", 580, 370);
        g.drawString("N/A", 580, 400);
        g.drawString("N/A", 580, 430);
        g.drawString("N/A", 580, 460);
        g.drawString("N/A", 580, 490);
        g.drawString("N/A", 580, 520);
        g.drawString("N/A", 580, 550);
                    ...
                    if (SystemCapacity - SystemSize >= e.j.size) {          //Add in queue if space is available
                        ...
                        if (OrbitSize > 0) {
                            if ((o.capacity - o.l.size()) >= e.j.size) {
                                ...
                                newev.time = GenerateArrival(alphaRetrial);
                                newev.j = new Job(e.j.size, newev.time);
                                newev.Type = Retrial;
