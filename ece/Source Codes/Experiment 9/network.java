...
public class network extends Applet implements ActionListener , Runnable{
	...
	private double waitTime1 , waitTime2 , waitTime3 , waitTime4 ,actualTime;
    ...
    public void actionPerformed(ActionEvent e) {
     ...
     public void CalculateSteadystagemeasures() {
		...
		double lambdda1 = lambda*(1-prob*(1-prob2))/((1-prob)*(1-prob2));
		double muu1 = mu1/((1-prob)*(1-prob2));
		double muu2 = mu2/((1-prob));
		double ro1 = lambdda1/mu1;
		double ro2 = muu1/mu2;
		double ro3 = muu2/mu3;
		...
		if(ro1 < 1 ){
			...
			SteadyMeanWaitingTimeQue1  = Double.toString(truncate(ro1/(mu1 - lambdda1)));
			SteadyMeanResponseTime1 = Double.toString(truncate(1/(mu1 - lambdda1)));
		...
		if(ro2 < 1 ){
			...
			SteadyMeanWaitingTimeQue2  = Double.toString(truncate(ro2/(mu2 - muu1)));
			SteadyMeanResponseTime2 = Double.toString(truncate(1/(mu2 - muu1)));
		...
		if(ro3 < 1 ){
			...
			SteadyMeanWaitingTimeQue3  = Double.toString(truncate(ro3/(mu3 - muu2)));
			SteadyMeanResponseTime3 = Double.toString(truncate(1/(mu3 - muu2)));
		...
		if(ro1 < 1 && ro2 < 1 && ro3 < 1){
			...
			SteadyMeanWaitingTimeQue  = Double.toString(truncate((ro3/(mu3 - muu2)) + (ro2/(mu2 - muu1)) + (ro1/(mu1 - lambdda1))));
			SteadyMeanResponseTime = Double.toString(truncate((1/(mu3 - muu2)) + (1/(mu2 - muu1)) + (1/(mu1 - lambdda1))));
