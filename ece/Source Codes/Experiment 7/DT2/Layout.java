...
public class Layout extends Applet implements ActionListener, Runnable {
...
public static double uniform() {
    ...
    //awt Components
    protected int canvasWidth = 700,  canvasHeight = 1000;
    ...
    Label label1,label2,label3,label4,label9;
    ...
    public void Join(Graphics g, Point p1) {
        ...
        g.setColor(Color.RED);
        g.fillOval((int) ((p1.x - 50) * scale + 47), (int) (270 - (270 - p1.y) * yscale-3),5,5) ;
   ...
   public void HandleError(int e) {
    ...
    public void init() {
        ...
        label4=new Label();
        label4.setText("System Capacity :");
        label9 = new Label();
