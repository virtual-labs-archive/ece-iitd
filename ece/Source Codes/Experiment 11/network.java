...
public class network extends Applet implements ActionListener , Runnable{
	...
	private static String SteadyMeanNoCustomersSys , SteadyMeanNoCustomersQue , SteadyMeanNoCustomersQue1 , SteadyMeanNoCustomersQue2 , SteadyMeanNoCustomersQue3  , SteadyMeanNoCustomerQue4;
	private double time = 0.0 , actualTime = 0.0;
	private double timeBusy1 , timeBusy2 , timeBusy3 , timeBusy4 ; 
    private static int SystemSize = 0;
    private Boolean playing = false, started = false;
    private Thread t;
	private int jobs1 , jobs2 , jobs3 , jobs4 ;
	...
	TextField lambda1 , mu11 , mu21 , mu31  , mu41 , prob1 , prob21  , prob31 , prob41 , job1 , job2 , job3 ,job4 ;
    Label label1,label2,label3,label4,label5,label6 , label7 ,label8  , label9 , label10 , label11 , label21 , label22 , label23 , label24;
	...
	public void PaintInitialGrid(Graphics g){
		...
		if(server.getState()){
			if(serverNum.getSelectedIndex() == 0){
				g.drawString("Mean No. of Customers with node 1", 60, 400);
				...
				g.drawString("Mean No. of Customers with node 2", 60, 400);
			...
			}else if(serverNum.getSelectedIndex() == 2) {
				...
				g.drawString("Mean No. of Customers with node 3", 60, 400);
				...
				g.drawString("Utilisation of node 4 ", 60, 520);
				g.drawString("Mean Sojourn Time with node 4", 60, 490);
				g.drawString("Mean Waiting Time in Queue 4  ", 60, 460);
				g.drawString("Mean number of customers in Queue 4", 60, 430);
				g.drawString("Mean No. of Customers with node 4", 60, 400);
				g.drawString("" + truncate(MeanNoCustomersQue4), 450, 400);
				g.drawString("" + truncate(MeanNoCustomersQueu4), 450, 430);
				g.drawString("" + truncate(waitTime4/waitCust4), 450, 460);
				if(customersServed4 == 0) g.drawString("N/A", 450, 490 );
				else g.drawString("" + (truncate(waitTime4/waitCust4 + timeBusy4 / customersServed4 )) , 450, 490 );
				g.drawString("" + truncate(timeBusy4/time), 450, 520);
			}
		}else{
			if(parameterReqd.getSelectedIndex() == 0){
				g.drawString("Mean No. of Customers in the System ", 60, 400);
				g.drawString("" + (jobs1 + jobs2 + jobs3 + jobs4), 450, 400);
				g.drawString("Mean No. of Customers with node 1", 60, 430);
				g.drawString("" + truncate(MeanNoCustomersQue1), 450, 430);
				g.drawString("Mean No. of Customers with node 2", 60, 460);
				g.drawString("" + truncate(MeanNoCustomersQue2), 450, 460);
				g.drawString("Mean No. of Customers with node 3", 60, 490);
				g.drawString("" + truncate(MeanNoCustomersQue3), 450, 490);
				g.drawString("Mean No. of Customers with node 4", 60, 520);
				g.drawString("" + truncate(MeanNoCustomersQue4), 450, 520);
				
			}else if(parameterReqd.getSelectedIndex() == 1){
				g.drawString("Mean number of customers waiting ", 60, 400);
				g.drawString("" + ( truncate(MeanNoCustomersQueu1 + MeanNoCustomersQueu2 + MeanNoCustomersQueu3 + MeanNoCustomersQueu4 ) ), 450, 400);
				g.drawString("Mean number of customers in Queue 1", 60, 430);
				g.drawString("" + truncate(MeanNoCustomersQueu1), 450, 430);
				g.drawString("Mean number of customers in Queue 2", 60, 460);
				g.drawString("" + truncate(MeanNoCustomersQueu2), 450, 460);
				g.drawString("Mean number of customers in Queue 3", 60, 490);
				g.drawString("" + truncate(MeanNoCustomersQueu3), 450, 490);
				g.drawString("Mean number of customers in Queue 4", 60, 520);
				g.drawString("" + truncate(MeanNoCustomersQueu4), 450, 520);
				
			}else if(parameterReqd.getSelectedIndex() == 2){
				double qaz = 0 , qax = 0 , qac = 0  , qav = 0;
				if(waitCust1 != 0) qaz = waitTime1 / waitCust1;
				if(waitCust2 != 0) qax = waitTime2 / waitCust2;
				if(waitCust3 != 0) qac = waitTime3 / waitCust3;
				if(waitCust4 != 0) qav = waitTime4 / waitCust4;
				
				
				g.drawString("Mean Waiting Time in system  ", 60, 400);
				g.drawString("" +  truncate(qaz +qax + qac + qav) , 450, 400);
				g.drawString("Mean Waiting Time in Queue 1  ", 60, 430);
				g.drawString("" + truncate(qaz), 450, 430);
				g.drawString("Mean Waiting Time in Queue 2  ", 60, 460);
				g.drawString("" + truncate(qax), 450, 460);
				g.drawString("Mean Waiting Time in Queue 3  ", 60, 490);
				g.drawString("" + truncate(qac), 450, 490);
				g.drawString("Mean Waiting Time in Queue 4  ", 60, 520);
				g.drawString("" + truncate(qav), 450, 520);
				...
				if(customersServed4 != 0) qav = waitTime4 / waitCust4 + timeBusy4 / customersServed4;
								
				g.drawString("Mean Sojourn Time in System ", 60, 400);
				g.drawString("" + truncate(qaz + qax + qac+ qav ) , 450, 400 );
				g.drawString("Mean Sojourn Time in System 1", 60, 430);
				g.drawString("" + truncate(qaz ) , 450, 430 );
				g.drawString("Mean Sojourn Time in System 2", 60, 460);
				g.drawString("" + truncate(qax) , 450, 460 );
				g.drawString("Mean Sojourn Time in System 3", 60, 490);
				g.drawString("" + truncate(qac ) , 450, 490 );
				g.drawString("Mean Sojourn Time in System 4", 60, 520);
				g.drawString("" + truncate(qav ) , 450, 520 );
			}else{
				g.drawString("Mean Utilisation of nodes  ", 60, 400);
				g.drawString("" + truncate((timeBusy1/time + timeBusy2/time + (timeBusy3+timeBusy4)/time  )/4), 450, 400);
				g.drawString("Utilisation of node 1 ", 60, 430);
				g.drawString("" + truncate(timeBusy1/time), 450, 430);
				g.drawString("Utilisation of node 2 ", 60, 460);
				g.drawString("" + truncate(timeBusy2/time), 450, 460);
				g.drawString("Utilisation of node 3 ", 60, 490);
				g.drawString("" + truncate(timeBusy3/time), 450, 490);
				g.drawString("Utilisation of node 4 ", 60, 520);
				g.drawString("" + truncate(timeBusy4/time), 450, 520);
        ...
        g.drawString("Customers Served by 1 = " + customersServed1, 120, 40);
        g.drawString("Customers Served by 2 = " + customersServed2, 120, 60);
        g.drawString("Customers Served by 3 = " + customersServed3, 120, 80);
        g.drawString("Customers Served by 4 = " + customersServed4, 120, 100);
        g.drawString("Customers in queue 1 = " + customersInQ1 , 400, 40);
        g.drawString("Customers in queue 2 = " + customersInQ2, 400, 60);
        g.drawString("Customers in queue 3 = " + customersInQ3, 400, 80);
        g.drawString("Customers in queue 4 = " + customersInQ4, 400, 100);
    ...
    public void DrawPath(Graphics g, LinkedList<Point> l , Color PathColor) {
     ...
     public void HandleError(int e) {
        ...
        if (e == 21) {
            g.drawString("*Error in Input In mu1", a, b + d * x);
            x++;
        }
        if (e == 22) {
            g.drawString("*mu1 Should Be Positive", a, b + d * x);
            x++;
        }
        if (e == 31) {
            g.drawString("*Error in Input In mu2", a, b + d * x);
            x++;
        }
        if (e == 32) {
            g.drawString("*mu2 Should Be Positive", a, b + d * x);
            x++;
        }
        if (e == 41) {
            g.drawString("*Error in Input In mu3", a, b + d * x);
            x++;
        }
        if (e == 42) {
            g.drawString("*mu3 Should Be Positive", a, b + d * x);
            x++;
        }
        if (e == 91) {
            g.drawString("*Error in Input In mu4", a, b + d * x);
            x++;
        }
        if (e == 92) {
            g.drawString("*mu4 Should Be Positive", a, b + d * x);
            x++;
        }
        if (e == 51) {
        ...
        if (e == 101) {
            g.drawString("Error in Jobs 1", a, b + d * x);
            x++;
        }
        if (e == 111) {
            g.drawString("Jobs 1 should positive", a, b + d * x);
            x++;
        }
        if (e == 102) {
            g.drawString("Error in Jobs 2", a, b + d * x);
            x++;
        }
        if (e == 112) {
            g.drawString("Jobs 2 should positive", a, b + d * x);
            x++;
        }
        if (e == 103) {
            g.drawString("Error in Jobs 3", a, b + d * x);
            x++;
        }
        if (e == 113) {
            g.drawString("Jobs 3 should positive", a, b + d * x);
            x++;
        }
        if (e == 104) {
            g.drawString("Error in Jobs 4", a, b + d * x);
            x++;
        }
        if (e == 114) {
            g.drawString("Jobs 4 should positive", a, b + d * x);
            x++;
        }
    ...
    public void init() {
		...
		queueGraphTotal  = new Checkbox("Total System" , null  , false);
		queueGraph1  = new Checkbox("Node 1        " , null  , true);
		queueGraph2  = new Checkbox("Node 2        " , null  , false);
		queueGraph3  = new Checkbox("Node 3        " , null  , false);
		queueGraph4  = new Checkbox("Node 4        " , null  , false);
        ...
        lambda1 = new TextField("1", 5);
        mu11 = new TextField("", 5);
        mu21 = new TextField("", 5);
        mu31 = new TextField("", 5);
        mu41 = new TextField("", 5);
		prob1 = new TextField("1" , 5);
		prob21 = new TextField("" , 5);
		prob31 = new TextField("" , 5);
		prob41 = new TextField("1" , 5);
		job1 = new TextField("" , 5);
		job2 = new TextField("" , 5);
		job3 = new TextField("" , 5);
		job4 = new TextField("" , 5);
		
       label1=new Label();
        label1.setText("Arrival Rate (lambda) :");
        label2=new Label();
        label2.setText("Service Rate 1 (mu1) :");
        label3=new Label();
        label3.setText("Service Rate 2 (mu2) :");
        label4=new Label();
        label4.setText("Service Rate 3 (mu3) :");
        label9=new Label();
        label9.setText("Service Rate 4 (mu4) :");
        label5 = new Label();
        label5.setText("p1:");
        label7 = new Label();
        label7.setText("p2:");
        ...
        label21 = new Label();
		label21.setText("Initial Jobs in server 1 :");
        label22 = new Label();
		label22.setText("Initial Jobs in server 2 :");
        label23 = new Label();
		label23.setText("Initial Jobs in server 3 :");
        label24 = new Label();
		label24.setText("Initial Jobs in server 4 :");
        Panel p1 = new Panel();
   ...
   public void actionPerformed(ActionEvent e) {
        if (e.getSource() == startButton) {
            if (startButton.getLabel().equals("Start")) {
                if (started == false) {
					...
					try {
                        jobs1 = Integer.parseInt(job1.getText());
                    } catch (NumberFormatException ee) {
                        etype = 101;
                        HandleError(etype);
                        jobs1 = 1;
                    ...
                    if (jobs1 < 0) {
                        ...
                        jobs2 = Integer.parseInt(job2.getText());
                    } catch (NumberFormatException ee) {
                        etype = 102;
                        HandleError(etype);
                        jobs2 = 1;
                    ...
                    if (jobs2 < 0) {
                        ...
                        jobs3 = Integer.parseInt(job3.getText());
                    } catch (NumberFormatException ee) {
                        etype = 103;
                        HandleError(etype);
                        jobs3 = 1;
                    ...
                    if (jobs3 < 0) {
                        ...
                        jobs4 = Integer.parseInt(job4.getText());
                    } catch (NumberFormatException ee) {
                        etype = 104;
                        HandleError(etype);
                        jobs4 = 4;
	...
	public void run() {
		...
		customersInQ4 = 0 ;
 		...
 		for(int jobLoop = 0 ; jobLoop < jobs1 ; jobLoop++){
			Job Test = new Job( 1 , GenerateTime(mu1) , 0);
			if(jobLoop == 0) mainQueue.push(Test);
			queue1.push(Test);
		}
		for(int jobLoop = 0 ; jobLoop < jobs2 ; jobLoop++){
			Job Test = new Job( 2 , GenerateTime(mu2) , 0);
			if(jobLoop == 0) {
				int lmno = 0;
				for(int qw = 0 ; qw < mainQueue.size() ; qw++ ){
					Job temp = mainQueue.getJob(qw);
					if(temp.time < Test.time ) lmno = qw+1;
				}
			mainQueue.addJob(Test , lmno);
			}
			
			queue2.push(Test);
		}
		for(int jobLoop = 0 ; jobLoop < jobs3 ; jobLoop++){
			Job Test = new Job( 3 , GenerateTime(mu3) , 0);
			if(jobLoop == 0) {
				int lmno = 0;
				for(int qw = 0 ; qw < mainQueue.size() ; qw++ ){
					Job temp = mainQueue.getJob(qw);
		...
		for(int jobLoop = 0 ; jobLoop < jobs4 ; jobLoop++){
			Job Test = new Job( 4 , GenerateTime(mu4) , 0);
			if(jobLoop == 0) {
				int lmno = 0;
				for(int qw = 0 ; qw < mainQueue.size() ; qw++ ){
					Job temp = mainQueue.getJob(qw);
...
//        g.setFont(font5);
		...
		int k;
         ...
         while (true) {
			...
			MeanNoCustomersQue4 = (queue4.size() + MeanNoCustomersQue4 * (loopTimes - 1)) / loopTimes;
			...
			Job e = mainQueue.pop();
			time = actualTime;
            actualTime = actualTime + e.time;       //update the time
		...
		if(e.stage == 0){
			...
			timeBusy3 = timeBusy3 + e.timeOr;customersServed3++;
			queue3.pop();
			...
			timeBusy4 = timeBusy4 + e.timeOr;customersServed4++;
			queue4.pop();
